    ...
    axios.post("http://localhost:8089/asset/create", newAssert)
        .then(response => {
            ...
            const category = {
                ...
                assetSubCategory: TypeCategory1
            }
            const data1 = []; 
            axios.get("http://localhost:8089/events/getbyType", category)
                .then(response => {
                    ...
                    const EventAssign = () => {
                        ...
                        response.data.data.map((events, index) => {
                            const Event = {
                                ...
                                eventfrequency: events.eventFrequecy,
                                duedate: `${duedateOneYear}`,
                                requiredEquipment: events.requiredEquipment,
                                requiredMatirial: events.requiredMatirial,
                                priority: events.priority,
                                assign: "false",
                            }
                            data1.push(Event)
                        }); 
                        setScheduleEvents(data1)          
                }
                EventAssign();
